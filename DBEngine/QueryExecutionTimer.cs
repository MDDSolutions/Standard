...
namespace MDDDataAccess
{
    public sealed class QueryExecutionMetrics
    {
        ...
        public long ReaderOpenTime => _enabled ? Interlocked.Read(ref _readerOpenTicks) - Interlocked.Read(ref _hydrateTicks) : 0;
        public long HydrationTime => _enabled ? Interlocked.Read(ref _hydrateTicks) - Interlocked.Read(ref _mapBuildTicks) - Interlocked.Read(ref _trackerProcessingTicks) : 0;
        ...
        public enum MetricType { Connection, Command, ReaderOpen, Hydration, MapBuild, TrackerProcessing }
    ...
    //    public long ReaderOpenTime => Interlocked.Read(ref _readerOpenTicks) - Interlocked.Read(ref _hydrateTicks);
    //    public long HydrationTime => Interlocked.Read(ref _hydrateTicks) - Interlocked.Read(ref _mapBuildTicks) - Interlocked.Read(ref _trackerProcessingTicks);
