...
namespace MDDDataAccess
{
    ...
    {
        public void ObjectFromReader_old<T>(SqlDataReader rdr, ref List<PropertyMapEntry> map, ref PropertyInfo key, ref T r, ref Tracker<T> tracker, bool strict = true) where T : class, new()
        {
