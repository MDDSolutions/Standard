...
namespace MDDFoundation
{
    ...
    public static partial class Foundation
    {
        ...
        public static FoundationLogger Logger { get; } = FoundationLogger.Default;
        public static void SetDefaultLogFileName(string filename)
        {
            DefaultLogFileName = string.IsNullOrWhiteSpace(filename) ? "Foundation_log.txt" : filename;
        }
        public static string LogFileFullName(string filename)
        {
            return Logger.ResolveLogFileName(string.IsNullOrWhiteSpace(filename) ? DefaultLogFileName : filename);
        }
        public static void Log(string LogStr, bool Initialize = false, string filename = null)
        {
            Logger.Write(LogStr, initialize: Initialize, fileName: filename);
        }
